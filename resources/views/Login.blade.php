        ...
        <div class="relative">
            <div class="bg-white shadow-xl p-7 py-14 w-96 rounded-md">
                ...
                <div class="form-group my-2">
                    ...
                    <input type="text" class="p-2 border mt-2 w-full focus:outline focus:outline-blue-700 rounded-sm"
                ...
                <p class="text-gray-500 my-3 ">Tidak memiliki akun? <a href="" class="text-blue-500">Daftar</a>
                </p>
                <button class="bg-blue-500 p-3 w-full font-bold text-white mt-3">Masuk</button>
            </div>
