...
<body class="bg-gray-100">
    <div class="flex">
        <aside class="w-3/12 bg-white h-screen rounded-tr-xl rounded-br-xl">
            ...
            <div id="main-menu">
                <div class="menu-item w-full flex flex-col px-4">
                    <div
                        class="flex gap-3 items-center p-3 hover:scale-105 transition-all duration-150 hover:bg-blue-700/20 hover:font-semibold">
        ...
        <main class="w-9/12 p-7 h-screen overflow-y-auto">
            ...
            <section class="grid gap-6 md:grid-cols-3 max-w-5xl mt-3">
            ...
            <div class="bg-white shadow rounded-md mt-4 p-3">
